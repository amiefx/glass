    ...
    <v-row>
      <v-col cols="6">
        <v-simple-table >
          ...
          <tbody>
            <tr v-for="item in order.purchaseorderdetails" :key="item.id">
          ...
          <v-simple-table >
            <tbody>
              ...
              <tr>
                <td></td>
                <td class="">Paid</td>
                <td class="px-0">Rs. {{ order.order.amount_paid }}</td>
              </tr>
              <tr>
                <td></td>
                <td class="">Balance</td>
                <td class="px-0">Rs. {{ order.order.total - order.order.amount_paid }}</td>
              </tr>
            </tbody>
          </v-simple-table>
        </div>
