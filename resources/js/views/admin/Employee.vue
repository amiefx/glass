  ...
  methods: {
      ...
      axios
        ...
        .then((res) => {
          this.text =
            ...
            "'s Status Updated to " +
            res.data.employee.is_active;
          this.snackbar = true;
        })
        .catch((error) => {
          // this.text = error.response.employee.name + "'s Status Cannot be Updated" + error.response.employee.status
          this.employees.data[index].is_active =
            error.response.data.employee.is_active;
          this.snackbar = true;
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        axios
          .put("/api/employees/" + this.editedItem.id, this.editedItem)
          //  .then(res => Object.assign(this.employees[this.editedIndex], this.editedItem))
          .then((res) => {
            console.log(res);
            this.text = "Record Updated Successfully!";
            this.snackbar = true;
            Object.assign(this.employees.data[index], res.data.employee);
          })
          .catch((err) => {
            console.log(err.response);
        ...
        axios
          .post("/api/employees", this.editedItem)
          .then((res) => {
            this.text = "Record Added Successfully!";
            this.snackbar = true;
            this.employees.data.push(res.data.employee);
          })
          .catch((err) => {
            console.dir(err);
